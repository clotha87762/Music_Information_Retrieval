...
filename = 'Albums-Ballroom_Classics4-01.wav';

%% 1., load wav file, automatically converted to Fs = 22050 and mono
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

[audio,fs] = audioread(strcat(dirWav,filename));  %wav_to_audio('',dirWav,filename);
Fs = fs;%sideinfo.wav.fs;
